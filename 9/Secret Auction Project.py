...
#
# This will happen if you’re using an IDE other than replit (e.g., VSCode, PyCharm etc).
# Similar to how we used the "random" module previously, in this project we will use the "replit" module. The `clear()` function is available here via the replit module without any extra configuration.
#
# **I’ll cover how to use PyCharm and import modules on Day 15**.
